...
var spheres = getJSONFile(INPUT_SPHERES_URL,"spheres");
...
function setColorUniforms(material){
  ...
  gl.uniform3fv(shaderProgram.lightLocation,[lights[0].x,lights[0].y,lights[0].z]);
...
function drawSphere(a,b,c,centerX,centerY,centerZ){
...
function initBuffers() {
  drawTriangle();
  drawSquare();
  drawSphere(spheres[0].a,spheres[0].b,spheres[0].c,spheres[0].x,spheres[0].y,spheres[0].z);//a,b,c,centerX,centerY,centerZ
  drawSphere(spheres[1].a,spheres[1].b,spheres[1].c,spheres[1].x,spheres[1].y,spheres[1].z);
  drawSphere(spheres[2].a,spheres[2].b,spheres[2].c,spheres[2].x,spheres[2].y,spheres[2].z);
}
...
function drawScene() {
  ...
  setMatrixUniforms();
  setColorUniforms(triangles[0].material);
  ...
  setMatrixUniforms();
  setColorUniforms(triangles[1].material);
  ...
  setMatrixUniforms();
  var sphere1Material = {};
  sphere1Material.diffuse = spheres[0].diffuse;
  sphere1Material.ambient = spheres[0].ambient;
  sphere1Material.specular = spheres[0].specular;
  sphere1Material.n = spheres[0].n;
  setColorUniforms(sphere1Material);
  ...
  setMatrixUniforms();
  var sphere2Material = {};
  sphere2Material.diffuse = spheres[1].diffuse;
  sphere2Material.ambient = spheres[1].ambient;
  sphere2Material.specular = spheres[1].specular;
  sphere2Material.n = spheres[1].n;
  setColorUniforms(sphere2Material);
  ...
  setMatrixUniforms();
  var sphere3Material = {};
  sphere3Material.diffuse = spheres[2].diffuse;
  sphere3Material.ambient = spheres[2].ambient;
  sphere3Material.specular = spheres[2].specular;
  sphere3Material.n = spheres[2].n;
  setColorUniforms(sphere3Material);
